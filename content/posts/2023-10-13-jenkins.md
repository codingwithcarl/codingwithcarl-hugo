...
The aim of this post was to aggregate everything I learned from disparate sources into one place. For more information, click on the references at the bottom of the page for a different explanation. I think it's a good idea to read different explanations on a single topic to gain additional context you wouldn't get from a single source. I hope this has helped you in some way and made your job a little easier.
